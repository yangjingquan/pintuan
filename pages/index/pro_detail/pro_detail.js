        ...
        if (from == 'join_group'){
          ...
          wx.request({
            ...
            success: function (res) {
              ...
              wx.navigateTo({
                url: '/pages/confirm_order/confirm_order?cart_id=' + cart_id + '&pro_id=' + pro_id + '&from=' + from + '&pintuan_count=' + pintuan_count + '&group_num=' + group_num,
              })
            }
          }) 
        }else{
          ...
          wx.request({
            ...
            success: function (res) {
              var cart_id = res.data.result
              wx.navigateTo({
                url: '/pages/confirm_order/confirm_order?cart_id=' + cart_id + '&pro_id=' + pro_id + '&from=' + from + '&pintuan_count=' + pintuan_count,
              })
            }
          }) 
        } 
